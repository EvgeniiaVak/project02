...
public class Player implements Comparable<Player>, Serializable {
  ...
  public int compareTo(Player other) {
    ...
    if (equals(other))
      return 0;
    //String thisPlayer = lastName + firstName;
    //String otherPlayer = other.lastName + other.firstName;
  ...
  public String toString() {
    String withOrWithout = "has zero";
    if (previousExperience) 
      withOrWithout = "has";
    return String.format("%s, %s, %d inches high, %s previous experience", 
                         lastName, firstName, heightInInches, withOrWithout);
  }
}
